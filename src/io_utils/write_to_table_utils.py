...
# Or keep the convenience function for gold only:
# def save_to_gold_table(df, table_key: str, environment: str = "dev", **kwargs):
#     """Convenience function for saving to gold layer"""
